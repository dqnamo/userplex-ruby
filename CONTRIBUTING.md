...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/userplex/helpers/` and `examples/` directory.
...
```ruby
gem "userplex", git: "https://www.github.com/stainless-sdks/userplex-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/stainless-sdks/userplex-ruby' '<path-to-repo>'
```

```ruby
gem "userplex", path: "<path-to-repo>"
```

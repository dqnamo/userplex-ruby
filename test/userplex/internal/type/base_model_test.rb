...
class Userplex::Test::PrimitiveModelTest < Minitest::Test
  A = Userplex::Internal::Type::ArrayOf[-> { Integer }]
  H = Userplex::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Userplex::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Userplex::Internal::Type::Unknown,
      Userplex::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Userplex::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Userplex::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Userplex::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Userplex::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Userplex::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Userplex::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Userplex::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Userplex::Internal::Type::Boolean, true] => true,
      [Userplex::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Userplex::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Userplex::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Userplex::Internal::Type::Converter.new_coerce_state
      Userplex::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Userplex::Internal::Type::Converter.dump(target, input, state: state)
...
class Userplex::Test::EnumModelTest < Minitest::Test
  class E0
    include Userplex::Internal::Type::Enum
...
class Userplex::Test::CollectionModelTest < Minitest::Test
  A1 = Userplex::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Userplex::Internal::Type::HashOf[Integer]

  A2 = Userplex::Internal::Type::ArrayOf[H1]
  H2 = Userplex::Internal::Type::HashOf[-> { A1 }]

  A3 = Userplex::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Userplex::Internal::Type::HashOf[Integer, nil?: true]
...
class Userplex::Test::BaseModelTest < Minitest::Test
  class M1 < Userplex::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Userplex::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Userplex::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Userplex::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Userplex::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Userplex::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Userplex::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Userplex::Errors::ConversionError => e
...
class Userplex::Test::UnionTest < Minitest::Test
  class U0
    include Userplex::Internal::Type::Union
  ...
  class M2 < Userplex::Internal::Type::BaseModel
  ...
  class M4 < Userplex::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Userplex::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Userplex::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Userplex::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Userplex::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Userplex::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Userplex::Internal::Type::Unknown, Userplex::Internal::Type::Unknown] => true,
      [Userplex::Internal::Type::Boolean, Userplex::Internal::Type::Boolean] => true,
      [Userplex::Internal::Type::Unknown, Userplex::Internal::Type::Boolean] => false,
...
class Userplex::Test::MetaInfoTest < Minitest::Test
  A1 = Userplex::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Userplex::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]

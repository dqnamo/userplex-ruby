...
class UserplexTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    stub_request(:post, "http://localhost/identify").to_return_json(status: 500, body: {})
  ...
  def test_client_retry_after_seconds
    stub_request(:post, "http://localhost/identify").to_return_json(
      status: 500,
  ...
  def test_default_headers
    stub_request(:post, "http://localhost/identify").to_return_json(status: 200, body: {})

...
class UserplexTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    stub_request(:post, "http://localhost/log").to_return_json(status: 500, body: {})
  ...
  def test_client_default_request_given_retry_attempts
    ...
    assert_raises(Userplex::Errors::InternalServerError) do
      userplex.logs.new(name: "name", request_options: {max_retries: 3})
    end
  ...
  def test_client_given_request_given_retry_attempts
    ...
    assert_raises(Userplex::Errors::InternalServerError) do
      userplex.logs.new(name: "name", request_options: {max_retries: 4})
    end
  ...
  def test_client_retry_after_seconds
    stub_request(:post, "http://localhost/log").to_return_json(
      status: 500,
  ...
  def test_omit_retry_count_header
    ...
    assert_raises(Userplex::Errors::InternalServerError) do
      userplex.logs.new(name: "name", request_options: {extra_headers: {"x-stainless-retry-count" => nil}})
    end
  ...
  def test_overwrite_retry_count_header
    ...
    assert_raises(Userplex::Errors::InternalServerError) do
      userplex.logs.new(name: "name", request_options: {extra_headers: {"x-stainless-retry-count" => "42"}})
    end
  ...
  def test_client_redirect_307
    ...
    assert_raises(Userplex::Errors::APIConnectionError) do
      userplex.logs.new(name: "name", request_options: {extra_headers: {}})
    end

    recorded, = WebMock::RequestRegistry.instance.requested_signatures.hash.first

    assert_requested(:any, "http://localhost/redirected", times: Userplex::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_keep_same_origin
    ...
    assert_raises(Userplex::Errors::APIConnectionError) do
      userplex.logs.new(name: "name", request_options: {extra_headers: {"authorization" => "Bearer xyz"}})
    end
  ...
  def test_default_headers
    stub_request(:post, "http://localhost/log").to_return_json(status: 200, body: {})

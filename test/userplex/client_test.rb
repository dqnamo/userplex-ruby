...
class UserplexTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    ...
    assert_raises(Userplex::Errors::InternalServerError) do
      userplex.events.capture(name: "name")
    end
  ...
  def test_client_default_request_given_retry_attempts
    ...
    assert_raises(Userplex::Errors::InternalServerError) do
      userplex.events.capture(name: "name", request_options: {max_retries: 3})
    end
  ...
  def test_client_given_request_given_retry_attempts
    ...
    assert_raises(Userplex::Errors::InternalServerError) do
      userplex.events.capture(name: "name", request_options: {max_retries: 4})
    end
  ...
  def test_client_redirect_307
    ...
    assert_raises(Userplex::Errors::APIConnectionError) do
      userplex.events.capture(name: "name", request_options: {extra_headers: {}})
    end

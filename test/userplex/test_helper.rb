...
class Userplex::Test::SingletonClient < Userplex::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Userplex::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Userplex::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @userplex = Userplex::Test::SingletonClient.instance
  end

      ...
      class PooledNetRequester
        ...
        class << self
          ...
          sig do
            params(
              request:
                Userplex::Internal::Transport::PooledNetRequester::Request,
        ...
        sig do
          params(
            request: Userplex::Internal::Transport::PooledNetRequester::Request
        ...
        def self.new(
          size: Userplex::Internal::Transport::PooledNetRequester::DEFAULT_MAX_CONNECTIONS
        )
        end
      end
    end

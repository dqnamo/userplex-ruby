    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  Userplex::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
          ...
          sig do
            params(
              ...
              spec: Userplex::Internal::AnyHash
            ).void
          end
        ...
        class << self
          ...
          sig do
            params(
              model: Userplex::Internal::Type::BaseModel,
              convert: T::Boolean
        ...
        sig { overridable.returns(Userplex::Internal::AnyHash) }
        def to_h
        end

  ...
  module Internal
    module Type
      ...
      module Converter
        ...
        Input =
          T.type_alias do
            T.any(Userplex::Internal::Type::Converter, T::Class[T.anything])
          end
        ...
        sig do
          overridable
            .params(
              value: T.anything,
              state: Userplex::Internal::Type::Converter::CoerceState
            )
            .returns(T.anything)
        end
        ...
        sig do
          overridable
            .params(
              value: T.anything,
              state: Userplex::Internal::Type::Converter::DumpState
            )
            .returns(T.anything)
        end
        ...
        class << self
            ...
            params(
              spec:
                T.any(
                  ...
                  T.proc.returns(Userplex::Internal::Type::Converter::Input),
                  Userplex::Internal::Type::Converter::Input
                )
          ...
          sig do
            ...
            ).returns(Userplex::Internal::AnyHash)
          end
          ...
          sig do
            params(translate_names: T::Boolean).returns(
              Userplex::Internal::Type::Converter::CoerceState
            )
          end
          ...
          sig do
            params(
              target: Userplex::Internal::Type::Converter::Input,
              value: T.anything,
              state: Userplex::Internal::Type::Converter::CoerceState
            ).returns(T.anything)
          end

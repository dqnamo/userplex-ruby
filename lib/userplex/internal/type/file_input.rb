...
module Userplex
  module Internal
    module Type
      ...
      # `Userplex::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | Userplex::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= Userplex::Internal::Type::FileInput
        ...
        class << self
          ...
          def dump(value, state:)
            ...
            in StringIO | String
              ...
              Userplex::FilePart.new(value, filename: "upload")
            in IO
              state[:can_retry] = false
              value.to_path.nil? ? Userplex::FilePart.new(value, filename: "upload") : value
            in Userplex::FilePart if value.content.is_a?(IO)
              state[:can_retry] = false
              value
            else
              value
          ...
          # @return [Object]
          def to_sorbet_type
            T.any(Pathname, StringIO, IO, String, Userplex::FilePart)
          end
        end
      end
    end

    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Userplex::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Userplex::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            Userplex::FilePart.new(value)
          in Userplex::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in Userplex::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Userplex::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Userplex::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Userplex::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Userplex::Internal::Type::Converter
              ...
              Userplex::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Userplex::Internal::Type::Converter, T::Class[T.anything]) }
        end

    ...
    module Util
      ...
      class << self
        ...
        def coerce_hash!(input)
          ...
          in Hash | nil => coerced
            ...
            message = "Expected a #{Hash} or #{Userplex::Internal::Type::BaseModel}, got #{data.inspect}"
      ...
      class << self
        ...
        private def write_multipart_chunk(y, boundary:, key:, val:, closing:)
          ...
          case val
          in Userplex::FilePart unless val.filename.nil?
        ...
        def encode_content(headers, body)
          ...
          in [Userplex::Internal::Util::JSON_CONTENT, Hash | Array | -> { primitive?(_1) }]
            [headers, JSON.generate(body)]
          in [Userplex::Internal::Util::JSONL_CONTENT, Enumerable] unless Userplex::Internal::Type::FileInput === body
            [headers, body.lazy.map { JSON.generate(_1) }]
          in [%r{^multipart/form-data}, Hash | Userplex::Internal::Type::FileInput]
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          # @api private
          #
          # @param type [Userplex::Internal::Util::SorbetRuntimeSupport, Object]
          #
          # @return [Object]
          def to_sorbet_type(type)
            case type
            in Userplex::Internal::Util::SorbetRuntimeSupport
              type.to_sorbet_type
            in Class | Module
              type
            in true | false
